...
{
    new Order { OrderID = 101, Customer = customers[0], OrderDate = DateTime.Now.AddDays(-5), Total = 150.75 },
    new Order { OrderID = 102, Customer = customers[1], OrderDate = DateTime.Now.AddDays(-3), Total = 200.00 },
    new Order { OrderID = 103, Customer = customers[0], OrderDate = DateTime.Now.AddDays(-1), Total = 50.25 }
};
